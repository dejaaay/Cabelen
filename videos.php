        ...
        <div class="bg-parent">
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            <h2>See through a foreign foodie's perspective with this video made by Best Ever Food Review Show.</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-parent">
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            <h2>A new Night Market just opened in San Fernando! Learn more through this GMA coverage of the Paskuhan Village Night Market.</h2>
                        </div>
                    </div>
                </div>
            </div>
